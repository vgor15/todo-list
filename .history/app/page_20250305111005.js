...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6">
      ...
      <form
        className="flex flex-col gap-4 bg-white p-6 rounded-lg shadow-xl w-full max-w-lg transition-all duration-300 ease-in-out"
        ...
        {mainTasks.length > 0 ? (
          <div className="grid gap-4">
            {mainTasks.map((task, index) => (
              <div
                key={index}
                className="bg-white p-4 rounded-lg shadow-md border border-gray-200 flex flex-col transition-all duration-300 ease-in-out"
...
/******  566a82f6-a49d-4d3d-91e9-d446dcd6f588  *******/